...
public class RabbitSenderService {
        ...
        try {
            if (StringUtils.isNotBlank(orderNo)) {
                ...
                if (info != null) {
                    ...
                    rabbitTemplate.setExchange(env.getProperty("mq.kill.item.success.email.exchang"));
                    ...
                    rabbitTemplate.convertAndSend(info, new MessagePostProcessor() {
                        ...
                        public Message postProcessMessage(Message message) throws AmqpException {
                            ...
                            messageProperties.setHeader(AbstractJavaTypeMapper.DEFAULT_CLASSID_FIELD_NAME, KillSuccessUserInfo.class);
                            return message;
                        }
                    });
                }
    ...
    /**
     * 秒杀成功后，生成抢购订单，发送信息入死信队列，等待着一定时间失效超时未支付的订单
     */
    public void sendKillSuccessOrderExpireMsg(String orderCode) {
        try {
            ...
            log.error("秒杀成功后生成抢购订单 - 发送信息入死信队列，等待着一定时间失效超时未支付的订单 - 发生异常，消息为：{}",
